...
import org.apache.hama.examples.util.SeqToTextMatrix;
import org.apache.hama.examples.util.TextToSeqMatrix;
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      pgd.addClass("bipartite", BipartiteMatching.class, 
          "Bipartite Matching");
      pgd.addClass("spmv", SpMV.class, "Sparse matrix-vector multiplication");
      pgd.addClass("rmgenerator", RandomMatrixGenerator.class,
          "Generator of random matrices");
      pgd.addClass("matrixtoseq", TextToSeqMatrix.class,
          "Conversion of matrix from text to sequence file");
